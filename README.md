...
### 🔹 [Stepper Motor Control (Verilog)](https://github.com/Anudeepreddynarala/Stepper_motor_control_verilog)
...
### 🔹 [Manufacturing Test Station](https://github.com/Anudeepreddynarala/manufacturing-test-station)
...
### 🔹 [Semiconductor Yield Analyzer](https://github.com/Anudeepreddynarala/semiconductor-yield-analyzer)
...
- 🔬 Building TinyML models for ultra-low-power microcontrollers
- ⚡ Optimizing real-time inference on edge devices (ESP32, Jetson)
- 🛠️ Designing custom FPGA IP cores for signal processing
- 📡 Developing IoT sensor networks with LoRa/BLE connectivity
- 🤖 Integrating AI/ML into embedded robotics applications
...
- 💼 LinkedIn: [anudeep-narala](https://linkedin.com/in/anudeep-narala)
